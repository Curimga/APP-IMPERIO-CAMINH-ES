---
name: kaio-supabase-fjvctjizmvvkbbstrobx
...
This folder is connected to Supabase project `fjvctjizmvvkbbstrobx` through MCP server `kaio_supabase_fjvctjizmvvkbbstrobx`.
